...
class WebViewBridgeClass {
  ...
  private async handleGetFCMToken(): Promise<string | null> {
    return FirebaseService.getFCMToken();
  }

  private async handleRequestLocationPermission(): Promise<boolean> {
    return LocationService.requestPermissions();
  }

  private async handleGetCurrentLocation(): Promise<LocationData> {
    return LocationService.getCurrentLocation();
  }

  private async handleStartLocationTracking(): Promise<void> {
  ...
  private async handleStopLocationTracking(): Promise<void> {
  ...
  private async handleStopBLEScan(): Promise<void> {
  ...
  private async handleRequestBluetoothPermission(): Promise<boolean> {
    return BLEService.requestPermissions();
  }
